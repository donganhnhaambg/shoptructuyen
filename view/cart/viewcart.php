...
<div class="boxtrai mr">
    <div class="row mb">
        ...
        <?php if (isLoggedIn()): ?>
            ...
            <?php else: ?>
                <div class="row mb bill">
                    <h2 style="color: red; margin-top:15px; font-size: 16px">Giỏ hàng trống</h2>
                    <a href="index.php"> <input type="button" value="Thêm sản phẩm"> </a>
                </div>
            <?php endif; ?>
        <?php else: ?>
            <div class="row">
                <h2 style="color: red;margin-top:15px; font-size: 16px">Vui lòng đăng nhập để thêm sản phẩm vào giỏ hàng.</h2>
            </div>
        <?php endif; ?>
    </div>
</div>
